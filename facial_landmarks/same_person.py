...
imgTest = face_recognition.load_image_file('/home/itsfod/Documents/tests/facial_landmarks/images/ali2.jpeg')
imgTest = cv2.cvtColor(imgTest, cv2.COLOR_BGR2RGB)

# Resizing the test image to the same size as the original image
